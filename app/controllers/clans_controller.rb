class ClansController < ApplicationController
  ...
  def authorize
	if current_user.nil?
      		...
      		if @clan && @clan.user != current_user
        		redirect_to root_path, alert: "Not authorized! Only #{@clan.user} has access to this post."
      		end
    	end
  end
  ...
  private
    ...
    def clan_params
      params.require(:clan).permit(:user_id, :dragon_id, :name, :species)
    end
end
