...
class ElementsControllerTest < ActionController::TestCase
  ...
  test "should create element" do
    assert_difference('Element.count') do
      post :create, element: { dragon_id: @element.dragon_id, name: @element.name, user_id: @element.user_id }
    end
  ...
  test "should update element" do
    patch :update, id: @element, element: { dragon_id: @element.dragon_id, name: @element.name, user_id: @element.user_id }
    assert_redirected_to element_path(assigns(:element))
  end
